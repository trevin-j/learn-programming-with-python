...
---
Because I want to make it as easy as possible for others to learn to program! I had a very difficult time when I was trying to learn on my own. It was so discouraging. I had no one that I could talk to that could help me! There are so many resources online, but I just didn't know how to find one that would actually help me and keep me engaged.

Existing tutorials and guides are great! But over the last few months I've started to think about the things that I wish were different for me when I was learning. I have been a part of several classes designed to teach programming. They all had a lot of great teaching strategies, but I felt like something was missing.

I am creating this guide to help guide the reader towards a goal. I want to teach you how to think like a programmer. I want my readers to get that fulfilling sense of accomplishment from writing their first program on their own. I want **you** to feel the power that you have at your fingertips whenever you are writing code! I want you to finsish this guide and walk away feeling confident in your new programming abilities.
...
## Tools we will use
---
We will go over the installation of any tools that we use, so don't worry about trying to set anything up on your own!

* Python - We will use Python to learn how to program! This tutorial will use Python 3.10.4, but any recent Python version should work just fine! If there are any big differences between versions, this tutorial will be updated to cover them.

* Visual Studio Code - Visual Studio Code is a fantastic open-source text editor that we will use to write our Python code. It has great extension support and works extremely well with all sorts of technologies. You are welcome to use any other text editor or IDE that you want, as long as you learn how to use it on your own!

* Some VS Code extensions - We will go over whcih ones when we get to it!
...
One of the main struggles that a lot of people have when they learn how to program isn't learning a programming language. In fact, learning a language is far easier than it sounds! The most difficult part about programming (in my own experience, as well as others I have spoken to about this) is learning how to think and solve problems like a programmer, and realizing how you can use what you've learned.

When I started learning programming on my own, you would not believe the amount of times that I would finish a tutorial and just think, "great! But now what?" It is fun and all to learn how to program by following a video series, and to make your own game with PyGame by following a tutorial, but once you can learn how to program using *your own* problem solving skills, you won't believe the rush you feel! I've never had a more fulfilling sense of accomplishment than the times that I finished a big section of code entirely by my self, using *my own* code.

This isn't to say that you shouldn't watch tutorial videos! In fact, watching [TechWithTim](https://www.youtube.com/TechWithTim) create games with Python helped me to learn a lot about programming! I have listed a lot of my personal favorite programming resources [here!](#resources)

Now, I have 3 ultimate goals that I want to accomplish with this guide.

1. I want you to learn *how to learn*. Being a programmer means you are always learning something new! I want you to learn how to keep learning on your own.

2. I want you to learn how to think like a programmer. This means learning how to think critically and deeply about each small, individual step. Every problem, no matter how big, can be solved with several very small steps.
...
Throughout this guide, I will do my best to employ a consistent teaching structure, designed to **teach**, **guide**, **challenge**, and **empower** you. I believe that if you follow along with every challenge and example, and spend a little bit of time on your own programming, you will be creating your own programs in no time at all. That isn't to say that this will be easy, but I will do my best to make it worth your while. And let's have some fun with it!
...
2. Example - Each lesson will have at least one example that we will walk through together. Remember to follow along! Writing your own code while following the example can make a huge difference to your success in this guide!
...
I wrote my first program when I was in 8th grade, on a calculator that is even older than I am! I wrote a simple program that calculated the Pythagorean Theorem (that I used on my math test!) in a language called Ti-Basic. Many Texas Instruments calculators support programming this language. I remember being so proud of myself for writing it.

When I was a senior in high school, my programming class used an online curriculum. Because of that, we could go at our own pace to learn Python. I finished the entire semester's worth of work in less than a month! That course only taught me the very very basics of Python, and I plan to go more in depth with this guide than that class did. But that class inspired me to work harder to learn on my own.

From there I began to teach myself something new about programming every single week. I followed several tutorials and learned a lot more than I had ever learned school.
